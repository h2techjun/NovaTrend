...
const DASHBOARDS = [
  {
    ...
    icon: TrendingUp,
    title: '글로벌 주식',
    description: '한국·미국·유럽 주식 뉴스를 AI가 실시간 분석',
  ...
  },
  {
    ...
    icon: Bitcoin,
    title: '크립토 마켓',
    description: 'BTC·ETH 뉴스 + 공포탐욕지수 실시간 추적',
  ...
  },
  {
    ...
    icon: Music,
    title: 'K-POP',
    description: '아이돌 뉴스·일정·콘서트 티켓 한눈에',
...
const FEATURES = [
  {
    icon: Sparkles,
    title: 'AI 감성 분석',
    description: 'KR-FinBERT + FinBERT로 대박호재~대박악재 4단계 자동 분류',
  },
  {
    icon: Shield,
    title: '중복 제거',
    description: '같은 사건의 여러 매체 기사 → 가장 신뢰도 높은 1건만 표시',
  },
  {
    icon: BarChart3,
    title: '정확도 학습',
    description: '과거 뉴스와 주가 흐름을 학습하여 분석 정확도 지속 향상',
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
              ...
              <br />
              등급으로{' '}
              <span className="gradient-text">한번에</span>
            </h1>

            <p className="mt-6 text-lg text-[hsl(var(--muted-foreground))] leading-relaxed max-w-2xl mx-auto">
              글로벌 주식, 크립토, K-POP 뉴스를 AI가 실시간 분석하여
              <br className="hidden sm:inline" />
              <span className="text-grade-big-good font-semibold"> 대박호재</span> /
              <span className="text-[#2979FF] font-semibold"> 호재</span> /
              <span className="text-[#FF6D00] font-semibold"> 악재</span> /
              <span className="text-grade-big-bad font-semibold"> 대박악재</span>
              로 분류합니다.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold sm:text-3xl">
            왜 <span className="gradient-text">NovaTrend</span>인가?
          </h2>
        </div>
